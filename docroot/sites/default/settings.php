 ...
 * @endcode
 */
$settings['hash_salt'] = 'SOHQVosic1g-ufyL6UGfDLALA_e3dzpf-d5vSBjP_AjiM8rTRLBKSc1bdFZpSOgWwGhYmyD0VA';
 ...
 */
#
if (file_exists($app_root . '/' . $site_path . '/settings.local.php') && isset($_SERVER['SERVER_NAME']) && (strpos($_SERVER['SERVER_NAME'], 'dev.') !== FALSE || strpos($_SERVER['SERVER_NAME'], 'debug.') !== FALSE)) {
